...
typedef NS_ENUM(NSUInteger, ZGMTRDeviceState) {
    ZGMTRDeviceStateUnknown = 0,
    ZGMTRDeviceStateReachable = 1,
    ZGMTRDeviceStateUnreachable = 2
};

@protocol ZGMTRDeviceDelegate;

ZGMTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1))
@interface ZGMTRDevice : NSObject
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;

/**
 * Get an ZGMTRDevice object representing a device with a specific node ID
 * associated with a specific controller.
 *
 * ZGMTRDevice objects are stateful, and callers should hold on to the ZGMTRDevice
 * while they are using it.
 */
+ (ZGMTRDevice *)deviceWithNodeID:(NSNumber *)nodeID
                     controller:(ZGMTRDeviceController *)controller ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

/**
 * The current state of the device.
 *
 * The three states:
 *   ZGMTRDeviceStateUnknown
 *      Unable to determine the state of the device at the moment.
 *
 *   ZGMTRDeviceStateReachable
 *      Communication with the device is expected to succeed.
 *
 *   ZGMTRDeviceStateUnreachable
 *      The device is currently unreachable.
 */
@property (nonatomic, readonly) ZGMTRDeviceState state;
 ...
 *
 */
@property (readonly) BOOL deviceCachePrimed ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
...
@property (nonatomic, readonly, nullable)
    NSDate * estimatedStartTime ZGMTR_AVAILABLE(ios(16.5), macos(13.4), watchos(9.5), tvos(16.5));

/**
 * The controller this device was created for.  May return nil if that
 * controller has been shut down.
 */
@property (nonatomic, readonly, nullable) ZGMTRDeviceController * deviceController ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4));

/**
 * The node ID of the node this device corresponds to.
 */
@property (nonatomic, readonly, copy) NSNumber * nodeID NS_REFINED_FOR_SWIFT ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4));
 ...
 */
@property (nonatomic, readonly, nullable, copy) NSNumber * estimatedSubscriptionLatency ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
 ...
 */
- (void)setDelegate:(id<ZGMTRDeviceDelegate>)delegate queue:(dispatch_queue_t)queue ZGMTR_DEPRECATED("Please use addDelegate:queue:interestedPaths:", ios(16.1, 18.0), macos(13.0, 15.0), watchos(9.1, 11.0), tvos(16.1, 18.0));
 ...
 * The delegate will be called on the provided queue, for attribute reports, event reports, and device state changes.
 *
 * ZGMTRDevice holds a weak reference to the delegate object.
 */
- (void)addDelegate:(id<ZGMTRDeviceDelegate>)delegate queue:(dispatch_queue_t)queue ZGMTR_AVAILABLE(ios(18.0), macos(15.0), watchos(11.0), tvos(18.0));
 ...
 *
 * interestedPathsForAttributes may contain either ZGMTRClusterPath or ZGMTRAttributePath to specify interested clusters and attributes, or NSNumber for endpoints.
 *
 * interestedPathsForEvents may contain either ZGMTRClusterPath or ZGMTREventPath to specify interested clusters and events, or NSNumber for endpoints.
 *
 ...
 * ZGMTRDevice holds a weak reference to the delegate object.
 */
- (void)addDelegate:(id<ZGMTRDeviceDelegate>)delegate queue:(dispatch_queue_t)queue interestedPathsForAttributes:(NSArray * _Nullable)interestedPathsForAttributes interestedPathsForEvents:(NSArray * _Nullable)interestedPathsForEvents ZGMTR_AVAILABLE(ios(18.0), macos(15.0), watchos(11.0), tvos(18.0));

/**
 * Removes the delegate from receiving callbacks about the device.
 */
- (void)removeDelegate:(id<ZGMTRDeviceDelegate>)delegate ZGMTR_AVAILABLE(ios(18.0), macos(15.0), watchos(11.0), tvos(18.0));
 ...
 *
 * @return a data-value dictionary of the attribute as described in ZGMTRDeviceResponseHandler,
 ...
 * ZGMTRDevice does not have attribute values for, will not be present in the
 * return value from this function.
 *
 * @return an array of response-value dictionaries as described in the
 *         documentation for ZGMTRDeviceResponseHandler.  Each one will have an
 *         ZGMTRAttributePathKey and an ZGMTRDataKey.
 */
- (NSArray<NSDictionary<NSString *, id> *> *)readAttributePaths:(NSArray<ZGMTRAttributeRequestPath *> *)attributePaths ZGMTR_NEWLY_AVAILABLE;

/**
 * Invoke a command with a designated command path
 *
 * @param commandFields command fields object. If not nil, the object must be a data-value
 *                      NSDictionary object as described in the ZGMTRDeviceResponseHandler
 *                      documentation. The value must be a Structure, i.e., the NSDictionary
 *                      ZGMTRTypeKey key must have the value ZGMTRStructureValueType.
 *
 ...
 *                       ZGMTRDeviceResponseHandler, and each one must have an ZGMTRAttributePathKey.
 *
 ...
 *                    response-value in it will have an ZGMTRCommandPathKey.  If the command
 *                    response is just a success status, there will be no ZGMTRDataKey.  If the
 *                    command response has data fields, there will be an ZGMTRDataKey, whose value
 *                    will be of type ZGMTRStructureValueType and describe the response payload.
 */
- (void)invokeCommandWithEndpointID:(NSNumber *)endpointID
              ...
              expectedValueInterval:(NSNumber * _Nullable)expectedValueInterval
                         ...
                         completion:(ZGMTRDeviceResponseHandler)completion ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4));
...
ZGMTR_EXTERN NSString * const ZGMTRPreviousDataKey ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
ZGMTR_EXTERN NSString * const ZGMTRDataVersionKey ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));

@protocol ZGMTRDeviceDelegate <NSObject>
@required
/**
 * @param state The current state of the device
 */
- (void)device:(ZGMTRDevice *)device stateChanged:(ZGMTRDeviceState)state;

/**
 * Notifies delegate of attribute reports from the ZGMTRDevice
 *
 * @param attributeReport  An array of response-value objects as described in ZGMTRDeviceResponseHandler
 *
 *                In addition to ZGMTRDataKey, each response-value dictionary in the array may also have this key:
 *
 *                ZGMTRPreviousDataKey : Same data-value dictionary format as the object for ZGMTRDataKey. This is included when the previous value is known for an attribute.
 *
 *                The data-value dictionary also contains this key:
 *
 *                ZGMTRDataVersionKey : NSNumber-wrapped uin32_t.
 */
- (void)device:(ZGMTRDevice *)device receivedAttributeReport:(NSArray<NSDictionary<NSString *, id> *> *)attributeReport;

/**
 * Notifies delegate of event reports from the ZGMTRDevice
 *
 * @param eventReport  An array of response-value objects as described in ZGMTRDeviceResponseHandler
 *
 *                In addition to the ZGMTREventPathKey and ZGMTRDataKey containing the path and event values, eventReport also contains
 *                these keys:
 *
 ...
 */
- (void)device:(ZGMTRDevice *)device receivedEventReport:(NSArray<NSDictionary<NSString *, id> *> *)eventReport;
 ...
 */
- (void)deviceBecameActive:(ZGMTRDevice *)device ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

/**
 * Notifies delegate when the device attribute cache has been primed with initial configuration data of the device
 *
 * This is called when the ZGMTRDevice object goes from not knowing the device to having cached the first attribute reports that include basic mandatory information, e.g. Descriptor clusters.
 *
 ...
 */
- (void)deviceCachePrimed:(ZGMTRDevice *)device ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));

/**
 * This is called when the ZGMTRDevice object detects a change in the device configuration.
 *
 * Device configuration is the set of functionality implemented by the device.
 *
 */
- (void)deviceConfigurationChanged:(ZGMTRDevice *)device ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));

@end

@interface ZGMTRDevice (Deprecated)

/**
 * Deprecated ZGMTRDevice APIs.
 */
+ (ZGMTRDevice *)deviceWithNodeID:(uint64_t)nodeID
               deviceController:(ZGMTRDeviceController *)deviceController
    ZGMTR_DEPRECATED(
