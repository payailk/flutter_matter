 ...
 */
ZGMTR_EXTERN ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6)) NSString * ZGMTRClusterNameForID(ZGMTRClusterIDType clusterID);
 ...
 * will be returned.
 */
ZGMTR_EXTERN ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6)) NSString * ZGMTRAttributeNameForID(ZGMTRClusterIDType clusterID, ZGMTRAttributeIDType attributeID);
 ...
 * will be returned.
 */
ZGMTR_EXTERN ZGMTR_NEWLY_AVAILABLE NSString * ZGMTRRequestCommandNameForID(ZGMTRClusterIDType clusterID, ZGMTRCommandIDType commandID);
 ...
 * will be returned.
 */
ZGMTR_EXTERN ZGMTR_NEWLY_AVAILABLE NSString * ZGMTRResponseCommandNameForID(ZGMTRClusterIDType clusterID, ZGMTRCommandIDType commandID);
 ...
 * will be returned.
 */
ZGMTR_EXTERN ZGMTR_NEWLY_AVAILABLE NSString * ZGMTREventNameForID(ZGMTRClusterIDType clusterID, ZGMTREventIDType eventID);
