...
@interface ZGMTRCertificates : NSObject
 ...
 * error.
 */
+ (ZGMTRCertificateDERBytes _Nullable)createRootCertificate:(id<ZGMTRKeypair>)keypair
    ...
    ZGMTR_AVAILABLE(ios(16.6), macos(13.5), watchos(9.6), tvos(16.6));
 ...
 * error.
 */
+ (ZGMTRCertificateDERBytes _Nullable)createIntermediateCertificate:(id<ZGMTRKeypair>)rootKeypair
 ...
 * error.
 */
+ (ZGMTRCertificateDERBytes _Nullable)createOperationalCertificate:(id<ZGMTRKeypair>)signingKeypair
                                              signingCertificate:(ZGMTRCertificateDERBytes)signingCertificate
 ...
 */
+ (BOOL)keypair:(id<ZGMTRKeypair>)keypair matchesCertificate:(NSData *)certificate;
 ...
 */
+ (BOOL)isCertificate:(ZGMTRCertificateDERBytes)certificate1 equalTo:(ZGMTRCertificateDERBytes)certificate2;

/**
 * Generate a PKCS#10 certificate signing request from a ZGMTRKeypair.  This can
 ...
 * error.
 */
+ (ZGMTRCSRDERBytes _Nullable)createCertificateSigningRequest:(id<ZGMTRKeypair>)keypair
                                                      error:(NSError * __autoreleasing _Nullable * _Nullable)error;
 ...
 */
+ (ZGMTRCertificateTLVBytes _Nullable)convertX509Certificate:(ZGMTRCertificateDERBytes)x509Certificate;
 ...
 */
+ (ZGMTRCertificateDERBytes _Nullable)convertMatterCertificate:(ZGMTRCertificateTLVBytes)matterCertificate
    ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 * would need to have.
 */
+ (NSData * _Nullable)publicKeyFromCSR:(ZGMTRCSRDERBytes)csr
                                 error:(NSError * __autoreleasing _Nullable * _Nullable)error
    ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

@end

@interface ZGMTRCertificates (Deprecated)

+ (nullable NSData *)generateRootCertificate:(id<ZGMTRKeypair>)keypair
                                    issuerId:(nullable NSNumber *)issuerId
                                    fabricId:(nullable NSNumber *)fabricId
                                       error:(NSError * __autoreleasing _Nullable * _Nullable)error
    ZGMTR_DEPRECATED("Please use createRootCertificate:issuerID:fabricID:error:", ios(16.1, 16.4), macos(13.0, 13.3),
        watchos(9.1, 9.4), tvos(16.1, 16.4));

+ (nullable NSData *)generateIntermediateCertificate:(id<ZGMTRKeypair>)rootKeypair
                                     rootCertificate:(NSData *)rootCertificate
                               intermediatePublicKey:(SecKeyRef)intermediatePublicKey
                                            issuerId:(nullable NSNumber *)issuerId
                                            fabricId:(nullable NSNumber *)fabricId
                                               error:(NSError * __autoreleasing _Nullable * _Nullable)error
    ZGMTR_DEPRECATED("Please use createIntermediateCertificate:rootCertificate:intermediatePublicKey:issuerID:fabricID:error:",
        ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));

+ (nullable NSData *)generateOperationalCertificate:(id<ZGMTRKeypair>)signingKeypair
...
+ (nullable NSData *)generateCertificateSigningRequest:(id<ZGMTRKeypair>)keypair
                                                 error:(NSError * __autoreleasing _Nullable * _Nullable)error
    ZGMTR_DEPRECATED("Please use createCertificateSigningRequest:error:", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4),
        tvos(16.1, 16.4));
