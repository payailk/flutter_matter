...
@interface ZGMTRDeviceAttestationInfo : NSObject
 ...
 */
@property (nonatomic, copy, readonly) ZGMTRTLVBytes elementsTLV;
/**
 ...
 */
@property (nonatomic, copy, readonly) ZGMTRCertificateDERBytes deviceAttestationCertificate;
/**
 ...
 */
@property (nonatomic, copy, readonly) ZGMTRCertificateDERBytes productAttestationIntermediateCertificate;
/**
...
- (instancetype)initWithDeviceAttestationChallenge:(NSData *)challenge
                                             nonce:(NSData *)nonce
                                       elementsTLV:(ZGMTRTLVBytes)elementsTLV
                                 elementsSignature:(NSData *)elementsSignature
                      deviceAttestationCertificate:(ZGMTRCertificateDERBytes)deviceAttestationCertificate
         productAttestationIntermediateCertificate:(ZGMTRCertificateDERBytes)processAttestationIntermediateCertificate
