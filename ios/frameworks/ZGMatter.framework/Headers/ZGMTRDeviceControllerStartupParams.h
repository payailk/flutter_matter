...
@interface ZGMTRDeviceControllerStartupParams : NSObject
 ...
 *
 * A controller created from ZGMTRDeviceControllerStartupParams initialized with
...
- (instancetype)initWithIPK:(NSData *)ipk
                  ...
                  nocSigner:(id<ZGMTRKeypair>)nocSigner ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
- (instancetype)initWithIPK:(NSData *)ipk
         operationalKeypair:(id<ZGMTRKeypair>)operationalKeypair
     operationalCertificate:(ZGMTRCertificateDERBytes)operationalCertificate
    intermediateCertificate:(ZGMTRCertificateDERBytes _Nullable)intermediateCertificate
            rootCertificate:(ZGMTRCertificateDERBytes)rootCertificate ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 * operational certificates.  In that case, the ZGMTRDeviceControllerStartupParams
 ...
 */
@property (nonatomic, copy, readonly, nullable) id<ZGMTRKeypair> nocSigner;
 ...
 */
@property (nonatomic, copy, readonly) NSNumber * fabricID ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 *   used.
 */
@property (nonatomic, copy, nullable) NSNumber * vendorID ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy, nullable) NSNumber * nodeID ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, copy, nullable)
    NSSet<NSNumber *> * caseAuthenticatedTags ZGMTR_AVAILABLE(ios(17.0), macos(14.0), watchos(10.0), tvos(17.0));
 ...
 *      certificate.
 */
@property (nonatomic, copy, nullable) ZGMTRCertificateDERBytes rootCertificate;
 ...
 */
@property (nonatomic, copy, readonly, nullable) ZGMTRCertificateDERBytes operationalCertificate;
 ...
 * nodeID.
 */
@property (nonatomic, strong, nullable) id<ZGMTRKeypair> operationalKeypair;
 ...
 */
@property (nonatomic, strong, nullable) id<ZGMTROperationalCertificateIssuer> operationalCertificateIssuer ZGMTR_AVAILABLE(
...
@property (nonatomic, strong, nullable)
    dispatch_queue_t operationalCertificateIssuerQueue ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

@end

@interface ZGMTRDeviceControllerStartupParams (Deprecated)

@property (nonatomic, assign, readonly) uint64_t fabricId ZGMTR_DEPRECATED(
    "Please use fabricID", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable) NSNumber * vendorId ZGMTR_DEPRECATED(
    "Please use vendorID", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable)
    NSNumber * nodeId ZGMTR_DEPRECATED("Please use nodeID", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));

- (instancetype)initWithSigningKeypair:(id<ZGMTRKeypair>)nocSigner
                              fabricId:(uint64_t)fabricId
                                   ipk:(NSData *)ipk ZGMTR_DEPRECATED("Please use initWithIPK:fabricID:nocSigner:", ios(16.1, 16.4),
                                           macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
- (instancetype)initWithOperationalKeypair:(id<ZGMTRKeypair>)operationalKeypair
                    operationalCertificate:(ZGMTRCertificateDERBytes)operationalCertificate
                   intermediateCertificate:(ZGMTRCertificateDERBytes _Nullable)intermediateCertificate
                           rootCertificate:(ZGMTRCertificateDERBytes)rootCertificate
                                       ipk:(NSData *)ipk
    ZGMTR_DEPRECATED("Please use initWithIPK:operationalKeypair:operationalCertificate:intermediateCertificate:rootCertificate:",
