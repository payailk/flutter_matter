...
@class ZGMTRBaseDevice;
@class ZGMTRServerEndpoint; // Defined in ZGMTRServerEndpoint.h, which imports ZGMTRAccessGrant.h, which imports ZGMTRBaseClusters.h, which imports this file, so we can't import it.

@class ZGMTRDeviceControllerAbstractParameters;

NS_ASSUME_NONNULL_BEGIN

ZGMTR_DEPRECATED("Please use ZGMTRBaseDevice deviceWithNodeID", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^ZGMTRDeviceConnectionCallback)(ZGMTRBaseDevice * _Nullable device, NSError * _Nullable error);

@class ZGMTRCommissioningParameters;
@class ZGMTRCommissionableBrowserResult;
@class ZGMTRSetupPayload;
@protocol ZGMTRDevicePairingDelegate;
@protocol ZGMTRDeviceControllerDelegate;

ZGMTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1))
@interface ZGMTRDeviceController : NSObject

/**
 * Controllers are created via the ZGMTRDeviceControllerFactory object or
 ...
 *
 * 1) Auto-start the ZGMTRDeviceControllerFactory in storage-per-controller mode
 ...
 */
- (nullable ZGMTRDeviceController *)initWithParameters:(ZGMTRDeviceControllerAbstractParameters *)parameters
                                               error:(NSError * __autoreleasing *)error ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
 ...
 */
@property (readonly, nonatomic, getter=isSuspended) BOOL suspended ZGMTR_NEWLY_AVAILABLE;

/**
 * The ID assigned to this controller at creation time.
 */
@property (readonly, nonatomic) NSUUID * uniqueIdentifier ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
...
@property (readonly, nonatomic, nullable)
    NSNumber * controllerNodeID ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 * occurs.  ZGMTRDeviceControllerDelegate will be notified as follows:
 *
 * * Discovery fails: onStatusUpdate with ZGMTRCommissioningStatusFailed.
 *
 ...
 * can be used to get an ZGMTRBaseDevice and discover what sort of network
 * credentials the device might need, and commissionDevice can be used to
 * commission the device.
 */
- (BOOL)setupCommissioningSessionWithPayload:(ZGMTRSetupPayload *)payload
 ...
 * occurs.  ZGMTRDeviceControllerDelegate will be notified as follows:
 *
 * * Invalid connection information: onStatusUpdate with ZGMTRCommissioningStatusFailed.
 *
 ...
 * commission the device.
 */
- (BOOL)setupCommissioningSessionWithDiscoveredDevice:(ZGMTRCommissionableBrowserResult *)discoveredDevice
                                              payload:(ZGMTRSetupPayload *)payload
                                            newNodeID:(NSNumber *)newNodeID
                                                error:(NSError * __autoreleasing *)error
...
- (BOOL)commissionNodeWithID:(NSNumber *)nodeID
         commissioningParams:(ZGMTRCommissioningParameters *)commissioningParams
                       error:(NSError * __autoreleasing *)error ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

/**
 * Call this method after ZGMTRDeviceAttestationDelegate
...
/**
 * Get an ZGMTRBaseDevice for a commissioning session that was set up for the
 * given node ID.  Returns nil if no such commissioning session is available.
 */
- (nullable ZGMTRBaseDevice *)deviceBeingCommissionedWithNodeID:(NSNumber *)nodeID
                                                        error:(NSError * __autoreleasing *)error
    ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

- (void)preWarmCommissioningSession ZGMTR_DEPRECATED("-[ZGMTRDeviceControllerFactory preWarmCommissioningSession]", ios(16.4, 17.6), macos(13.3, 14.6), watchos(9.4, 10.6), tvos(16.4, 17.6));
 ...
 */
- (void)setDeviceControllerDelegate:(id<ZGMTRDeviceControllerDelegate>)delegate
 ...
 *
 * Multiple delegates can be added to monitor ZGMTRDeviceController state changes. Note that there should only
 ...
 * @param[in] queue The queue on which the callbacks will be delivered
 */
- (void)addDeviceControllerDelegate:(id<ZGMTRDeviceControllerDelegate>)delegate
                              queue:(dispatch_queue_t)queue ZGMTR_NEWLY_AVAILABLE;
 ...
 */
- (void)removeDeviceControllerDelegate:(id<ZGMTRDeviceControllerDelegate>)delegate ZGMTR_NEWLY_AVAILABLE;
 ...
 */
- (BOOL)startBrowseForCommissionables:(id<ZGMTRCommissionableBrowserDelegate>)delegate
                                queue:(dispatch_queue_t)queue ZGMTR_AVAILABLE(ios(17.0), macos(14.0), watchos(10.0), tvos(17.0));
 ...
 */
- (BOOL)stopBrowseForCommissionables ZGMTR_AVAILABLE(ios(17.0), macos(14.0), watchos(10.0), tvos(17.0));
 ...
 */
- (BOOL)addServerEndpoint:(ZGMTRServerEndpoint *)endpoint ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
 ...
 * else.
 */
- (void)removeServerEndpoint:(ZGMTRServerEndpoint *)endpoint queue:(dispatch_queue_t)queue completion:(dispatch_block_t)completion ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));

/**
 * Remove the given server endpoint without being notified when the removal
 * completes.
 */
- (void)removeServerEndpoint:(ZGMTRServerEndpoint *)endpoint ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
 ...
 */
- (void)suspend ZGMTR_NEWLY_AVAILABLE;
 ...
 */
- (void)resume ZGMTR_NEWLY_AVAILABLE;
 ...
 * ZGMTRDeviceControllerFactory, to avoid leaking the controller.
 */
- (void)shutdown;
...
@interface ZGMTRDeviceController (Deprecated)

@property (readonly, nonatomic, nullable) NSNumber * controllerNodeId ZGMTR_DEPRECATED(
...
- (BOOL)getBaseDevice:(uint64_t)deviceID
    ...
    completionHandler:(ZGMTRDeviceConnectionCallback)completionHandler
    ZGMTR_DEPRECATED("Please use [ZGMTRBaseDevice deviceWithNodeID:controller:]", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4),
        tvos(16.1, 16.4));

- (BOOL)getZGBaseDevice:(uint64_t)deviceID
                queue:(dispatch_queue_t)queue
    completionHandler:(ZGMTRDeviceConnectionCallback)completionHandler
    ZGMTR_DEPRECATED("Please use [ZGMTRBaseDevice deviceWithNodeID:controller:]", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4),
        tvos(16.1, 16.4));
...
- (BOOL)pairDevice:(uint64_t)deviceID
     discriminator:(uint16_t)discriminator
      setupPINCode:(uint32_t)setupPINCode
             error:(NSError * __autoreleasing *)error
    ZGMTR_DEPRECATED("Please use setupCommissioningSessionWithPayload:newNodeID:error:", ios(16.1, 16.4), macos(13.0, 13.3),
...
- (BOOL)commissionDevice:(uint64_t)deviceId
     commissioningParams:(ZGMTRCommissioningParameters *)commissioningParams
                   error:(NSError * __autoreleasing *)error
    ZGMTR_DEPRECATED("Please use commissionNodeWithID:commissioningParams:error:", ios(16.1, 16.4), macos(13.0, 13.3),
        watchos(9.1, 9.4), tvos(16.1, 16.4));
...
- (nullable ZGMTRBaseDevice *)getDeviceBeingCommissioned:(uint64_t)deviceId
                                                 error:(NSError * __autoreleasing *)error
    ZGMTR_DEPRECATED("Please use deviceBeingCommissionedWithNodeID:error:", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4),
        tvos(16.1, 16.4));

- (BOOL)openPairingWindow:(uint64_t)deviceID
                 duration:(NSUInteger)duration
                    error:(NSError * __autoreleasing *)error
    ZGMTR_DEPRECATED("Please use ZGMTRDevice or ZGMTRBaseDevice openCommissioningWindowWithSetupPasscode", ios(16.1, 16.4),
...
- (nullable NSData *)computePaseVerifier:(uint32_t)setupPincode
                              iterations:(uint32_t)iterations
                                    salt:(NSData *)salt
    ZGMTR_DEPRECATED("Please use computePASEVerifierForSetupPasscode:iterations:salt:error:", ios(16.1, 16.4), macos(13.0, 13.3),
        watchos(9.1, 9.4), tvos(16.1, 16.4));

- (void)setPairingDelegate:(id<ZGMTRDevicePairingDelegate>)delegate
                     queue:(dispatch_queue_t)queue ZGMTR_DEPRECATED("Please use setDeviceControllerDelegate:", ios(16.1, 16.4),
                               macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));

- (void)setNocChainIssuer:(id<ZGMTRNOCChainIssuer>)nocChainIssuer
                    queue:(dispatch_queue_t)queue
    ZGMTR_DEPRECATED("Please set the operationalCertificateIssuer in the ZGMTRDeviceControllerStartupParams instead.", ios(16.1, 16.4),
        macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@end
