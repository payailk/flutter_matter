...
/**
 * A representation of a server cluster implemented by an ZGMTRDeviceController.
 *
 * ZGMTRServerCluster's API can be accessed from any thread.
 */
NS_SWIFT_SENDABLE
ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6))
@interface ZGMTRServerCluster : NSObject

- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;

/**
 * The provided clusterID must not be ZGMTRClusterIDTypeDescriptorID; see
 ...
 *
 * If this cluster is the Descriptor cluster (id ZGMTRClusterIDTypeDescriptorID),
 ...
 * the cluster.
 */
- (BOOL)addAttribute:(ZGMTRServerAttribute *)attribute;
 ...
 */
+ (ZGMTRServerCluster *)newDescriptorCluster;
 ...
 */
@property (atomic, copy, readonly) NSArray<ZGMTRAccessGrant *> * accessGrants;

/**
 * The list of attributes supported by the cluster.
 */
@property (atomic, copy, readonly) NSArray<ZGMTRServerAttribute *> * attributes;
