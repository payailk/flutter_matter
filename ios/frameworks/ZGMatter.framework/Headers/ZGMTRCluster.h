...
ZGMTR_DEPRECATED("ResponseHandler is not used", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^ResponseHandler)(id _Nullable value, NSError * _Nullable error);
ZGMTR_DEPRECATED("Please use ZGMTRStatusCompletion instead", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^StatusCompletion)(NSError * _Nullable error);
ZGMTR_DEPRECATED(
    "Please use ZGMTRSubscriptionEstablishedHandler instead", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
typedef void (^SubscriptionEstablishedHandler)(void);

typedef void (^ZGMTRStatusCompletion)(NSError * _Nullable error);
typedef void (^ZGMTRSubscriptionEstablishedHandler)(void);
typedef void (^ZGMTRSubscriptionEstablishedWithIdHandler)(NSNumber * _Nonnull subscriptionId);
...
@interface ZGMTRCluster : NSObject
 ...
 */
@property (nonatomic, readonly) NSNumber * endpointID NS_REFINED_FOR_SWIFT ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4));
@end

/**
 * Base for all ZGMTRBaseCluster* types.
 */
ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4))
@interface ZGMTRGenericBaseCluster : ZGMTRCluster
@end

/**
 * Base for all ZGMTRCluster* types.
 */
ZGMTR_AVAILABLE(ios(17.4), macos(14.4), watchos(10.4), tvos(17.4))
@interface ZGMTRGenericCluster : ZGMTRCluster
/**
 * The device this cluster object is associated with.
 */
@property (nonatomic, strong, readonly) ZGMTRDevice * device;
@end
 ...
 */
ZGMTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1))
@interface ZGMTRWriteParams : NSObject <NSCopying, NSSecureCoding>
 ...
 *    If not provided (i.e. nil passed for the ZGMTRReadParams argument), will be
 *    treated as if a default-initialized object was passed in.
 */
ZGMTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1))
@interface ZGMTRReadParams : NSObject <NSCopying, NSSecureCoding>
...
@property (nonatomic, assign, getter=shouldFilterByFabric)
    BOOL filterByFabric ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy, nullable) NSNumber * minEventNumber ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 * The default is YES.
 *
 * This setting is only relevant to some consumers of ZGMTRReadParams.  One of
 * those consumers is readAttributeWithEndpointID:clusterID:attributeID:params:
 * on ZGMTRDevice.
 */
@property (nonatomic, assign, getter=shouldAssumeUnknownAttributesReportable) BOOL assumeUnknownAttributesReportable ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));

@end

/**
 * ZGMTRSubscribeParams
 *    This is used to control the behavior of attribute/event subscribes.  If not
 *    provided (i.e. nil passed for the ZGMTRSubscribeParams argument), will be
 *    treated as if a default-initialized object was passed in.
 */
ZGMTR_AVAILABLE(ios(16.1), macos(13.0), watchos(9.1), tvos(16.1))
@interface ZGMTRSubscribeParams : ZGMTRReadParams <NSCopying, NSSecureCoding>
...
@property (nonatomic, assign, getter=shouldReplaceExistingSubscriptions)
    BOOL replaceExistingSubscriptions ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, assign, getter=shouldResubscribeAutomatically)
    BOOL resubscribeAutomatically ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy) NSNumber * minInterval ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
 ...
 */
@property (nonatomic, copy) NSNumber * maxInterval ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));
...
@property (nonatomic, assign, getter=shouldReportEventsUrgently)
    BOOL reportEventsUrgently ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4));

/**
 * Initialize an ZGMTRSubscribeParams.  Must provide a minInterval and
...
@interface ZGMTRReadParams (Deprecated)

@property (nonatomic, copy, nullable) NSNumber * fabricFiltered ZGMTR_DEPRECATED(
    "Please use filterByFabric", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));

@end

@interface ZGMTRSubscribeParams (Deprecated)

@property (nonatomic, copy, nullable) NSNumber * keepPreviousSubscriptions ZGMTR_DEPRECATED(
    "Please use replaceExistingSubscriptions", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable) NSNumber * autoResubscribe ZGMTR_DEPRECATED(
