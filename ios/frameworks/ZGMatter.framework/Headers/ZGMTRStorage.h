...
@protocol ZGMTRStorage <NSObject>
@required
...
ZGMTR_DEPRECATED("Please use ZGMTRStorage", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
@protocol ZGMTRPersistentStorageDelegate <ZGMTRStorage>
@end
