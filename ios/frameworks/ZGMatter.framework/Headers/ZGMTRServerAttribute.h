 ...
 * ZGMTRDeviceController.  An attribute has an identifier and a value, and may or
 * may not be writable.
 *
 * ZGMTRServerAttribute's API can be accessed from any thread.
 */
NS_SWIFT_SENDABLE
ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6))
@interface ZGMTRServerAttribute : NSObject
 ...
 */
- (nullable instancetype)initReadonlyAttributeWithID:(NSNumber *)attributeID initialValue:(NSDictionary<NSString *, id> *)value requiredPrivilege:(ZGMTRAccessControlEntryPrivilege)requiredPrivilege;
 ...
 * for FeatureMap.
 */
+ (ZGMTRServerAttribute *)newFeatureMapAttributeWithInitialValue:(NSNumber *)value;
 ...
 */
@property (atomic, assign, readonly) ZGMTRAccessControlEntryPrivilege requiredReadPrivilege;
