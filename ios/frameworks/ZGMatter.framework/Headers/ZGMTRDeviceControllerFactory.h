...
@protocol ZGMTRStorage;
@protocol ZGMTRPersistentStorageDelegate;
@protocol ZGMTROTAProviderDelegate;
@protocol ZGMTRKeypair;

@class ZGMTRDeviceControllerStartupParams;
@class ZGMTRFabricInfo;

ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4))
@interface ZGMTRDeviceControllerFactoryParams : NSObject
 ...
 * is used to initialize the ZGMTRDeviceControllerFactoryParams.  If "init" is
 * used, this property will contain a dummy storage that will not be used for
 * anything.
 */
@property (nonatomic, strong, readonly) id<ZGMTRStorage> storage;
 ...
 * concurrently.
 */
@property (nonatomic, strong, nullable) id<ZGMTROTAProviderDelegate> otaProviderDelegate;
 ...
 * Defaults to nil.
 */
@property (nonatomic, copy, nullable) NSArray<ZGMTRCertificateDERBytes> * productAttestationAuthorityCertificates;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<ZGMTRCertificateDERBytes> * certificationDeclarationCertificates;
 ...
 * framework.
 */
- (instancetype)initWithStorage:(id<ZGMTRStorage>)storage;

@end

ZGMTR_AVAILABLE(ios(16.4), macos(13.3), watchos(9.4), tvos(16.4))
@interface ZGMTRDeviceControllerFactory : NSObject

- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;

/**
 * Return the single ZGMTRDeviceControllerFactory we support existing.  It starts off
 * in a "not started" state.
 */
+ (ZGMTRDeviceControllerFactory *)sharedInstance;
...
/**
 * Returns the list of ZGMTRFabricInfo representing the fabrics the
 * ZGMTRDeviceControllerFactory knows about and the corresponding node identities
 ...
 */
@property (readonly, nonatomic, nullable) NSArray<ZGMTRFabricInfo *> * knownFabrics;
 ...
 */
- (BOOL)startControllerFactory:(ZGMTRDeviceControllerFactoryParams *)startupParams error:(NSError * __autoreleasing *)error;
...
/**
 * Create a ZGMTRDeviceController on an existing fabric.  Returns nil on failure.
 *
 ...
 * When using per-controller storage, use [ZGMTRDeviceController initWithParameters:error:].
 */
- (ZGMTRDeviceController * _Nullable)createControllerOnExistingFabric:(ZGMTRDeviceControllerStartupParams *)startupParams
                                                              error:(NSError * __autoreleasing *)error;

/**
 * Create a ZGMTRDeviceController on a new fabric.  Returns nil on failure.
 *
 ...
 * When using per-controller storage, use [ZGMTRDeviceController initWithParameters:error:].
 */
- (ZGMTRDeviceController * _Nullable)createControllerOnNewFabric:(ZGMTRDeviceControllerStartupParams *)startupParams
                                                         error:(NSError * __autoreleasing *)error;

/**
 * If possible, pre-warm the Matter stack for setting up a commissioning session.
 *
 * This may be called before -[ZGMTRDeviceController setupCommissioningSessionWithPayload:]
 ...
 */
- (void)preWarmCommissioningSession ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6));
 ...
 *                                    parameters.
 */
ZGMTR_EXTERN ZGMTR_AVAILABLE(ios(17.6), macos(14.6), watchos(10.6), tvos(17.6)) void ZGMTRSetMessageReliabilityParameters(NSNumber * _Nullable idleRetransmitMs,
    NSNumber * _Nullable activeRetransmitMs,
    NSNumber * _Nullable activeThresholdMs,
    NSNumber * _Nullable additionalRetransmitDelayMs);

ZGMTR_DEPRECATED(
    "Please use ZGMTRDeviceControllerFactoryParams", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
@interface ZGMTRControllerFactoryParams : ZGMTRDeviceControllerFactoryParams
@property (nonatomic, strong, readonly) id<ZGMTRPersistentStorageDelegate> storageDelegate ZGMTR_DEPRECATED(
    "Please use the storage property", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, assign) BOOL startServer ZGMTR_DEPRECATED(
    "Please use shouldStartServer", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable) NSArray<NSData *> * paaCerts ZGMTR_DEPRECATED(
    "Please use productAttestationAuthorityCertificates", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@property (nonatomic, copy, nullable) NSArray<NSData *> * cdCerts ZGMTR_DEPRECATED(
    "Please use certificationDeclarationCertificates", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4));
@end

ZGMTR_DEPRECATED("Please use ZGMTRDeviceControllerFactory", ios(16.1, 16.4), macos(13.0, 13.3), watchos(9.1, 9.4), tvos(16.1, 16.4))
@interface ZGMTRControllerFactory : NSObject
@property (readonly, nonatomic) BOOL isRunning;
+ (ZGMTRControllerFactory *)sharedInstance;
- (BOOL)startup:(ZGMTRControllerFactoryParams *)startupParams;
- (void)shutdown;
- (ZGMTRDeviceController * _Nullable)startControllerOnExistingFabric:(ZGMTRDeviceControllerStartupParams *)startupParams;
- (ZGMTRDeviceController * _Nullable)startControllerOnNewFabric:(ZGMTRDeviceControllerStartupParams *)startupParams;
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;
@end
